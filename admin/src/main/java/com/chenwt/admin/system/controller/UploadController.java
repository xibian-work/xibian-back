package com.chenwt.admin.system.controller;
...
import com.chenwt.component.fileUpload.enums.UploadResultEnum;
...
public class UploadController {
     ...
     * 保存上传的web格式图片
     */
    public ResultVo saveImage(MultipartFile multipartFile, Upload upload) throws IOException, NoSuchAlgorithmException {
        // 判断是否为支持的图片格式
        String[] types = {
                "image/gif",
                "image/jpg",
