...
import com.chenwt.component.actionLog.action.model.ActionModel;
import com.chenwt.component.actionLog.action.model.BusinessMethod;
import com.chenwt.component.actionLog.action.model.BusinessType;
...
public class ActionLogAop {
    ...
    @Pointcut("@annotation(com.chenwt.component.actionLog.annotation.ActionLog)")
    ...
    public Object recordLog(ProceedingJoinPoint point) throws Throwable {
        ...
        com.chenwt.component.actionLog.annotation.ActionLog anno =
                targetMethod.getAnnotation(com.chenwt.component.actionLog.annotation.ActionLog.class);
        // 获取name值
